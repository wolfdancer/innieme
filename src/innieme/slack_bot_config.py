...
class ChannelConfig(BaseModel):
    channel_id: str  # Slack channel IDs are strings
...
class OutieConfig(BaseModel):
    outie_id: str  # Slack user IDs are strings
    topics: List[TopicConfig]
    bot: 'SlackBotConfig' = None  # type: ignore
...
class SlackBotConfig(BaseModel):
    ...
    @classmethod
    def from_yaml(cls, yaml_content: str) -> "SlackBotConfig":
